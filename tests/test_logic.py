import pytest
import create_app
from create_app.generator.utils import normalize_name # Assuming you have a name cleaner
...
class TestAppLogic:
    ...
    def test_framework_logos(self):
        ...
        for framework in ["django", "fastapi", "flask"]:
            logo_url = create_app.FRAMEWORK_LOGOS.get(framework)
            assert logo_url is not None
            assert logo_url.startswith("https://cdn.simpleicons.org")
